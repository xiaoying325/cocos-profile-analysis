...
@ccclass
export default class UIPopupA extends UIBase {
    public uiName: string = "UIPopupA";
    ...
    public onFocus(...params: any[]): void {
        console.log('UIPopupA onFocus', ...params);
    ...
    protected onFocusGained(...params: any[]): void {
        console.log('UIPopupA 获得焦点，可以在这里刷新规则数据');
    ...
    public onFocusLost(...params: any[]): void {
        console.log('UIPopupA 失去焦点，可以在这里保存规则设置');
